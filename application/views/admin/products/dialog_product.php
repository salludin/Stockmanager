          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_acc_product_p_price');?>" name="purchase_price" type="number" value="<?php echo $purchase_price;?>">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label for="retail_price"><?php echo $this->lang->line('xin_acc_product_s_price');?></label>
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_acc_product_s_price');?>" name="retail_price" type="number" value="<?php echo $retail_price;?>">
              </div>
            </div>
          </div>
          <div class="row">
