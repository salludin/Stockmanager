                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_acc_purchase_no');?>" name="purchase_number" type="text" value="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-12">
                          <div class="table-responsive">
                            <table class="table">
                              ...
                              <tr>
                                <td style="text-align: right;"><label for="supplier_id">Status</label></td>
                                <td class="text-xs-right"><?php $payment_methods = $all_payment_methods->result();?>
                                  <select class="form-control" name="payment_method" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select');?>">
                                    ...
                                    <option value="<?php echo $pmethod->payment_method_id?>"><?php echo $pmethod->method_name?></option>
                                    <?php } ?>
                                  </select></td>
                              </tr>
                                </tbody>
